...
only that itworks for all those supported formats alike. ``collectiongain`` on
the other hand is a kind of fire-and-forget tool for big amounts of music
files.
"""
...
setup(
    name="rgain2",
    version=__version__,
    description="Multi-format Replay Gain utilities for Python 3",
